...
export default function InteractiveHero() {
  return (
    <section className="relative h-screen bg-black flex items-center justify-center px-6 text-white">

      {/* Glow sutil */}
      <div className="absolute w-[800px] h-[800px] bg-blue-500/10 rounded-full blur-3xl" />

      {/* Ventana estilo mac */}
      <div className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl max-w-5xl w-full p-12">
